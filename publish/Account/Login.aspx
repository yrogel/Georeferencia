...
<head>
	...
	<!-- CSS Page Style -->
	<link rel="stylesheet" href="<%: ResolveUrl("~/Content/assets/css/pages/page_log_reg_v2.css")%>">
...
<body>
	...
	<div class="container">
		...
		<div class="reg-block">
            ...
            <form runat="server">
				...
				<p>No se preocupe, <a class="color-green" href='<%=ResolveUrl("~/RecuperarContraseña") %>'>haga clic aquí</a> para restablecer su contraseña.</p>
	...
	<script type="text/javascript" src="<%: ResolveUrl("~/Content/assets/plugins/backstretch/jquery.backstretch.min.js") %>"></script>
	<!-- JS Customization -->
	...
	<script type="text/javascript">
		$.backstretch([
			'<%=ResolveUrl("~/Content/assets/img/bg/3.jpg")%>',
			'<%=ResolveUrl("~/Content/assets/img/bg/11.jpg")%>'
			], {
				fade: 1000,
				duration: 7000
			});
