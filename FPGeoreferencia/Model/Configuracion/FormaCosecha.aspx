<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormaCosecha.aspx.cs" Inherits="FPGeoreferencia.Model.Configuracion.FormaCosecha" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainBreadcrumbs" runat="server">
    <div class="container">
		<ul class="pull-left breadcrumb">
			<li>Configuración</li>
            <li class="active">Forma cosecha</li>
		</ul>
	</div>
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <input type="button" id="btnNewFormaCosecha" name="btnNewFormaCosecha" class="btn rounded btn-success" value="Nuevo"/>
    <div style="height: 10px;"></div>
    
    <dx:ASPxGridView ID="gridFormaCosecha" ClientInstanceName="gridFormaCosecha" runat="server" DataSourceID="SqlFormaCosecha" 
        ...
        <SettingsText Title="Forma Cosecha" />
    ...
    <dx:ASPxPopupControl ID="PopUpNewFormaCosecha" runat="server" CloseAction="CloseButton" ShowCloseButton="False"
        PopupHorizontalAlign="WindowCenter" AllowDragging="True" PopupVerticalAlign="WindowCenter" ClientInstanceName="PopUpNewFormaCosecha"
        HeaderText="Creación de Forma Cosecha" Modal="True" PopupAnimationType="Fade" EnableViewState="True" Theme="DevEx" Width="600px">
    ...
    <asp:SqlDataSource ID="SqlFormaCosecha" runat="server" ConnectionString="<%$ ConnectionStrings:FPGeoreferencia%>" 
            SelectCommand="GetFormaCosecha" SelectCommandType="StoredProcedure" UpdateCommand="UpdFormaCosecha" UpdateCommandType="StoredProcedure" >
        <UpdateParameters>
    ...
    <script>
        $("#btnNewFormaCosecha").click(function () {
            $("#<%= mensaje.ClientID %>").css('display', 'none');
            ClearFormFormaCosecha();
            PopUpNewFormaCosecha.Show();
        });

        $('#btnCancelar').click(function () {
            PopUpNewFormaCosecha.Hide();
            gridFormaCosecha.PerformCallback("databind");
        });
        ...
        $('#btnGuardar').click(function () {
            ...
            if (nombre == "") {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%= Page.ResolveUrl("~/Model/Configuracion/FormaCosecha.aspx/InsertaFormaCosecha")%>',
        ...
        function ClearFormFormaCosecha() {
