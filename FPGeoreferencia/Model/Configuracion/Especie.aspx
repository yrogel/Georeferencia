<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Especie.aspx.cs" Inherits="FPGeoreferencia.Model.Configuracion.Especie" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainBreadcrumbs" runat="server">
    <div class="container">
		<ul class="pull-left breadcrumb">
			<li>Configuración</li>
            <li class="active">Fauna acompañante</li>
		</ul>
	</div>
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <input type="button" id="btnNewEspecie" name="btnNewEspecie" class="btn rounded btn-success" value="Nuevo"/>
    <div style="height: 10px;"></div>
    
    <dx:ASPxGridView ID="gridEspecie" ClientInstanceName="gridEspecie" runat="server" DataSourceID="SqlEspecie" 
    ...
    <dx:ASPxPopupControl ID="PopUpNewEspecie" runat="server" CloseAction="CloseButton" ShowCloseButton="False"
        PopupHorizontalAlign="WindowCenter" AllowDragging="True" PopupVerticalAlign="WindowCenter" ClientInstanceName="PopUpNewEspecie"
        HeaderText="Creación de Fauna Acompañante" Modal="True" PopupAnimationType="Fade" EnableViewState="True" Theme="DevEx" Width="600px">
    ...
    <asp:SqlDataSource ID="SqlEspecie" runat="server" ConnectionString="<%$ ConnectionStrings:FPGeoreferencia%>" 
            SelectCommand="GetEspecie" SelectCommandType="StoredProcedure" UpdateCommand="UpdEspecie" UpdateCommandType="StoredProcedure" >
        <UpdateParameters>
    ...
    <script>
        $("#btnNewEspecie").click(function () {
            ...
            ClearFormEspecie();
            PopUpNewEspecie.Show();
        });

        $('#btnCancelar').click(function () {
            PopUpNewEspecie.Hide();
            gridEspecie.PerformCallback("databind");
        });
        ...
        $('#btnGuardar').click(function () {
            ...
            if (nombre == "") {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%= Page.ResolveUrl("~/Model/Configuracion/Especie.aspx/InsertaEspecie")%>',
