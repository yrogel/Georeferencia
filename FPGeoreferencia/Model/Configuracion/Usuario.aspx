...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxGridView ID="gridUsuario" ClientInstanceName="gridUsuario" runat="server" DataSourceID="SqlUsuario" 
        ...
        <Columns>
            ...
            <dx:GridViewDataColumn FieldName="Correo" VisibleIndex="9" Caption="Correo">
             ...
             <dx:GridViewDataColumn FieldName="Estado" VisibleIndex="10" Caption="Estado">
                <HeaderStyle Font-Bold="True" />
                 <EditFormSettings Visible="False" />
            </dx:GridViewDataColumn>
    ...
    <script>
        ...
        $('#btnGuardar').click(function () {
            ...
            if (login == "" || password == "" || rol == 0 || nombre == "" || rut == "") {
                ...
                var obj = { "login": login, "password": password, "rol": rol, "nombre": nombre, "rut": rut, "direccion": direccion, "telefono": telefono, "correo": correo };
