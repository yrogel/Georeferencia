<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TipoCosecha.aspx.cs" Inherits="FPGeoreferencia.Model.Configuracion.TipoCosecha" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainBreadcrumbs" runat="server">
    <div class="container">
		<ul class="pull-left breadcrumb">
			<li>Configuración</li>
            <li class="active">Tipo Cosecha</li>
		</ul>
	</div>
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <input type="button" id="btnNewTipoCosecha" name="btnNewTipoCosecha" class="btn rounded btn-success" value="Nuevo"/>
    <div style="height: 10px;"></div>
    
    <dx:ASPxGridView ID="gridTipoCosecha" ClientInstanceName="gridTipoCosecha" runat="server" DataSourceID="SqlTipoCosecha" 
        ...
        <SettingsText Title="Tipo Cosecha" />
        <Settings ShowFilterRow="True" ShowFooter="True" />
                    
    </dx:ASPxGridView>
    </div>
    
    <dx:ASPxPopupControl ID="PopUpNewTipoCosecha" runat="server" CloseAction="CloseButton" ShowCloseButton="False"
        PopupHorizontalAlign="WindowCenter" AllowDragging="True" PopupVerticalAlign="WindowCenter" ClientInstanceName="PopUpNewTipoCosecha"
        HeaderText="Creación de Tipo Cosecha" Modal="True" PopupAnimationType="Fade" EnableViewState="True" Theme="DevEx" Width="600px">
    ...
    <asp:SqlDataSource ID="SqlTipoCosecha" runat="server" ConnectionString="<%$ ConnectionStrings:FPGeoreferencia%>" 
            SelectCommand="GetTipoCosecha" SelectCommandType="StoredProcedure" UpdateCommand="UpdTipoCosecha" UpdateCommandType="StoredProcedure" >
        <UpdateParameters>
    ...
    <script>
        $("#btnNewTipoCosecha").click(function () {
            $("#<%= mensaje.ClientID %>").css('display', 'none');
            ClearFormTipoCosecha();
            PopUpNewTipoCosecha.Show();
        });

        $('#btnCancelar').click(function () {
            PopUpNewTipoCosecha.Hide();
            gridTipoCosecha.PerformCallback("databind");
        });
        ...
        $('#btnGuardar').click(function () {
            ...
            if (nombre == "") {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%= Page.ResolveUrl("~/Model/Configuracion/TipoCosecha.aspx/InsertaTipoCosecha")%>',
