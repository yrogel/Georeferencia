...
{
    public partial class TipoCosecha : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string InsertaTipoCosecha(string nombre)
        {
            try
            {
                if (BusinessData.Dalc.Cosecha.CreaTipoCosecha(nombre) == "0")
                    return "0";
                return "1";
            }
