<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UbicacionCuelga.aspx.cs" Inherits="FPGeoreferencia.Model.Configuracion.UbicacionCuelga" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainBreadcrumbs" runat="server">
    <div class="container">
		<ul class="pull-left breadcrumb">
			<li>Configuración</li>
            <li class="active">Ubicación Cuelga</li>
		</ul>
	</div>
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <input type="button" id="btnNewUbicacionCuelga" name="btnNewUbicacionCuelga" class="btn rounded btn-success" value="Nuevo"/>
    <div style="height: 10px;"></div>
    
    <dx:ASPxGridView ID="gridUbicacionCuelga" ClientInstanceName="gridUbicacionCuelga" runat="server" DataSourceID="SqlUbicacionCuelga" 
        ...
        <SettingsText Title="Ubicación Cuelga" />
        <Settings ShowFilterRow="True" ShowFooter="True" />
                    
    </dx:ASPxGridView>
    </div>
    
    <dx:ASPxPopupControl ID="PopUpNewUbicacionCuelga" runat="server" CloseAction="CloseButton" ShowCloseButton="False"
        PopupHorizontalAlign="WindowCenter" AllowDragging="True" PopupVerticalAlign="WindowCenter" ClientInstanceName="PopUpNewUbicacionCuelga"
        HeaderText="Creación de Ubicación Cuelga" Modal="True" PopupAnimationType="Fade" EnableViewState="True" Theme="DevEx" Width="600px">
    ...
    <asp:SqlDataSource ID="SqlUbicacionCuelga" runat="server" ConnectionString="<%$ ConnectionStrings:FPGeoreferencia%>" 
            SelectCommand="GetUbicacionCuelga" SelectCommandType="StoredProcedure" UpdateCommand="UpdUbicacionCuelga" UpdateCommandType="StoredProcedure" >
        <UpdateParameters>
    ...
    <script>
        $("#btnNewUbicacionCuelga").click(function () {
            $("#<%= mensaje.ClientID %>").css('display', 'none');
            ClearFormUbicacionCuelga();
            PopUpNewUbicacionCuelga.Show();
        });

        $('#btnCancelar').click(function () {
            PopUpNewUbicacionCuelga.Hide();
            gridUbicacionCuelga.PerformCallback("databind");
        });
        ...
        $('#btnGuardar').click(function () {
            ...
            if (nombre == "") {
                ...
                $.ajax({
                    type: "POST",
                    url: '<%= Page.ResolveUrl("~/Model/Configuracion/UbicacionCuelga.aspx/InsertaUbicacionCuelga")%>',
        ...
        function ClearFormUbicacionCuelga() {
