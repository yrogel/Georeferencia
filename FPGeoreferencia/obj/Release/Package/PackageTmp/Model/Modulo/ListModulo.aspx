...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxPopupControl ID="PopUpNewModulo" runat="server" CloseAction="CloseButton" ShowCloseButton="False"
        ...
        <dx:ASPxGridView ID="gridModulos" ClientInstanceName="gridModulos" runat="server" DataSourceID="SqlDataSource1"
            ...
            <Columns>
                ...
                <dx:GridViewDataComboBoxColumn FieldName="Id_Especie" VisibleIndex="5" Caption="Especie">
                    <HeaderStyle Font-Bold="True" />
                    <PropertiesComboBox DataSourceID="SqlDataEspecie" ValueType="System.Int32" ValueField="Id" TextField="Nombre" />
